...
import com.example.proglayout.csound.listener.CachedOutputNamesInt;
...
public class ShowInts implements Unit {
	
	@Override
	public String getTag() {	
		return Units.SHOW_INTS;
	}
	...
	public View getView(final LayoutContext ctx, Object tagValue,
		...
		return UnitUtils.run(this, ctx, tagValue, new WithId() {
			...
			public View apply(String id) {
				...
				new CachedOutputNamesInt(id, tv).addToCsound(ctx.getApp());				
				return tv;				
			}
		});		
